...
const projects = [
    { image: logo, tools: ["TypeScript", "JavaScript", "React", "TailwindCSS", "ExpressJS", "PostgreSQL"], title: "CookKeeper", body: "CookKeeper is a full-stack CRUD application designed to simplify the process of storing, organizing, and managing personal recipes.", github: "https://github.com/spencerhum04/CookKeeper" },
    { image: logo, tools: ["TypeScript", "JavaScript", "React", "TailwindCSS", "ExpressJS", "MongoDB", "mongoose", "AtlasDB"], title: "MERN Stack", body: "Fullstack type shi", github: "https://github.com/spencerhum04/mern-stack" },
...
export default function Projects() {
    return (
        <div className="flex flex-col py-20 lg:items-center">
            ...
            <div className="overflow-x-auto hide-scrollbar mt-12">
                <div className="flex flex-row gap-x-4 justify-start w-max px-6">
                    {projects.map((project, index) => (
                        <div key={index} className="bg-white w-full max-w-[358px] h-[615px] rounded-[40px] px-2.5 pt-2.5 pb-6 flex flex-col justify-between relative overflow-hidden">
                            ...
                            <a href={project.github} target="_blank" rel="noopener noreferrer" className="flex flex-row gap-x-2.5 items-center px-2.5">
