...
const projects = [
    ...
    { image: logo, tools: ["JavaScript", "p5js", "TailwindCSS", "ExpressJS", "Firebase"], title: "Genetic Rockets", body: "Fullstack type shi", github: "https://github.com/spencerhum04/Genetic-Rockets" },
]

export default function Projects() {
    return (
        <div className="flex flex-col gap-y-10 py-20 lg:items-center">
