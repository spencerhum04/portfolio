    ...
    return (
        <div className="flex flex-col items-center px-6 pt-24 pb-40">
            ...
            <div className="w-full flex flex-wrap place-content-center gap-10 mt-12">
                <Workplace name={"Canada Computers & Electronics"} role={"Software Engineer · Internship"} date={"Sept 2024 - Dec 2024"} image={canadaComputers} />
                <Workplace name={"Yupi.ca"} role={"Software Engineer · Internship"} date={"May 2025 - Apr 2026"} image={yupi} />
            </div>
        </div>
    )
}
