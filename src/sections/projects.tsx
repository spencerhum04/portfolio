...
const projects = [
    { image: logo, tools: ["TypeScript", "JavaScript", "React", "TailwindCSS", "ExpressJS", "PostgreSQL"], title: "CookKeeper", body: "CookKeeper is a full-stack CRUD application designed to simplify the process of storing, organizing, and managing personal recipes. It provides a seamless way to catalog your favorite recipes, complete with ingredients, instructions and total time.", github: "github.com/akdoawkkda" },
    { image: logo, tools: ["Nuxt", "Vue", "TailwindCSS", "ExpressJS", "Firebase"], title: "RealmGuide", body: "Fullstack type shi", github: "github.com/akdoawkkda" },
    { image: logo, tools: ["Expressjs", "PostgreSQL", "React"], title: "CookKeeper", body: "Fullstack type shi", github: "github.com/akdoawkkda" },
]
            ...
            <div className="flex flex-row gap-x-8 justify-center items-center mt-10">
                {projects.map(project => (
                    <div className="bg-white w-[350px] h-[475px] rounded-xl px-2.5 pt-2.5 pb-6 flex flex-col justify-between">
                        ...
                        <div className="flex flex-row gap-x-2.5 items-center px-2.5 hover:underline">
